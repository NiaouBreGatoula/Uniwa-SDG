...
const indicator_13: IndicatorType = {
  ...
  sections: [
    {
      label: "Cubic Meters of Water (m^3)",
      selectedValue: null,
      type: "NumberField",
      placeholder: "Enter the number of cubic meters (m^3)",
    },
    {
      label: "Campus Population",
      selectedValue: null,
...
const indicator_17: IndicatorType = {
  ...
  sections: [
    ...
    {
      label: "University Floor Area (m^2)",
      selectedValue: null,
      type: "NumberField",
      placeholder: "Enter the total floor area in m^2",
    },
  ],
  type: "NumberField",
};
